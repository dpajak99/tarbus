...
public class Vehicle implements MapItem {
  ...
  private String warTrasy;
  private String kierunek;
  private int idKursu;
  private int lpPrzyst;
  private int drogaPlan;
  private int drogaWyko;
  private double dlugosc;
  private double szerokosc;
  private double prevDlugosc;
  private double prevSzerokosc;
  private int odchylenie;
  private String odchylenieStr;
  private int stan;
  private String planGodzRozp;
  private int nastIdKursu;
  private String nastPlanGodzRozp;
  private String nastNumLini;
  private String nastWarTrasy;
  private String nastKierunek;
  private int ileSekDoOdjazdu;
  private String typPojazdu;
  private String cechy1;
  private String destination;
  private String cechy3;
  private int wektor;
