...
public class DatabaseRouteVariant {
  @ColumnInfo(name = "id")
  int id;
  ...
  public DatabaseRouteVariant(int id, int budStopId, int wariantId, @NonNull String routeDescription, @NonNull String firstBusStop, @NonNull String lastBusStop, @NonNull String checkpoints) {
    this.id = id;
